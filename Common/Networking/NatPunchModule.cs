...
namespace Promul.Common.Networking
{
    ...
    public sealed class NatPunchModule
    {
        ...
        internal void ProcessMessage(IPEndPoint senderEndPoint, NetPacket packet)
        {
            ...
            {
                // TODO maybe not this
                _cacheReader = new NetDataReader(new ArraySegment<byte>(packet.Data.Array, packet.Data.Offset + NetConstants.HeaderSize, packet.Data.Count - NetConstants.HeaderSize));
