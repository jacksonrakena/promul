   ...
   internal sealed class NetConnectRequestPacket
    {
        ...
        public static NetConnectRequestPacket FromData(NetPacket packet)
        {
            ...
            if (packet.Size > HeaderSize+addrSize)
                reader = new NetDataReader(new ArraySegment<byte>(packet.RawData, HeaderSize + addrSize, packet.Size));
        ...
        {
            //Make initial packet
            var packet = new NetPacket(PacketProperty.ConnectRequest, connectData.Count+addressBytes.Size);
