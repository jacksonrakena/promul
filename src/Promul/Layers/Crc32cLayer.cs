namespace Promul
{
    ...
    //     }
    //
    //     public override void ProcessInboundPacket(ref IPEndPoint endPoint, ref NetPacket packet)
    //     {
    //         if (packet.Size < NetConstants.HeaderSize + CRC32C.ChecksumSize)
    //         {
    ...
    //         }
    //
    //         int checksumPoint = packet.Size - CRC32C.ChecksumSize;
    //         if (CRC32C.Compute(packet.RawData, packet., checksumPoint) != BitConverter.ToUInt32(data, checksumPoint))
    //         {
