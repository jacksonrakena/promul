...
namespace Promul.Networking
{
    public class PausedSocketFix
    {
        private readonly Promul.PromulManager _netManager;
        ...
        public PausedSocketFix(Promul.PromulManager netManager, IPAddress ipv4, IPAddress ipv6, int port, bool manualMode)
        {
